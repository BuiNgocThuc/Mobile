    ...
    public class MainActivity extends AppCompatActivity {
        ...
        private void openEmailApp1(String input) {
            String email = null;
            email=input.substring(input.indexOf("MAILTO:")+7);
            if (email != null) {
        ...
        private void openEmailApp2(String input){
            ...
            int emailStart = input.indexOf("MATMSG:TO:")+10;
        ...
        private void openSmsApp(String input) {
            String phonenum = null;
            String body = null;

            int numStart = input.indexOf("SMSTO:")+6;
            int numEnd = input.indexOf(":",numStart);
            if(numStart>=0 && numEnd>=0){
                phonenum=input.substring(numStart,numEnd);
            }

            int bodyStart = numEnd+1;
            if(bodyStart>=0){
                body=input.substring(bodyStart);
            }
